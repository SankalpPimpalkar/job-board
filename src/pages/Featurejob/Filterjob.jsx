...
function Filterjob() {
  ...
  return (
    <div className="bg-white p-6 shadow-md rounded-lg w-full md:w-64 lg:w-72 max-w-xs text-left">
    ...
    <div className="flex flex-col space-y-4 items-start">
      ...
      <div className="w-full">
        <h3 className="text-black text-lg font-bold mb-2">Job Type</h3>
      ...
      <div className="w-full">
        <h3 className="text-black text-lg font-bold mb-2">Experience Level</h3>
        <div className="flex flex-col space-y-2">
          {["Entry Level", "Mid Level", "Senior Level"].map((level, index) => (
            ...
            >
              <input
                ...
                checked={filters[level.toLowerCase().replace(" ", "")]}
                onChange={handleCheckboxChange}
                className="w-4 h-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
              />
              <span>{level}</span>
      ...
      <div className="w-full">
        <h3 className="text-black text-lg font-bold mb-2">Salary Range</h3>
        <div className="flex flex-col space-y-2">
          {[
            "$0 - $50,000",
            "$50,000 - $100,000",
